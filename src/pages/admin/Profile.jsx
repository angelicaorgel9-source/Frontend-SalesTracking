...
import LogOutModal from '../../components/admin/modals/LogOutModal.jsx'
import EditProfileModal from '../../components/admin/modals/EditProfileModal.jsx'
...
export default function AdminProfile() {
  ...
  const { profile, openEditProfile, showEditProfile, closeEditProfile } = useAdminProfile()
  ...
  return (
    <AdminLayout topbarProps={{ title: 'MJ Prints' }}>
