...
import LogOutModal from '../../components/employee/modals/LogOutModal.jsx'
import EditProfileModal from '../../components/employee/modals/EditProfileModal.jsx'
...
export default function AdminProfile() {
  ...
  const { profile, openEditProfile, showEditProfile, closeEditProfile } = useEmployeeProfile()
  ...
  return (
    <EmployeeLayout topbarProps={{ title: 'MJ Prints' }}>
          ...
          <div className="flex-row gap-12">
            ...
            <div>
              <div className="flex-row gap-8">
                ...
                <span className="badge badge-neutral">e-001</span>
              </div>
              <div className="cell-sub" style={{ marginBottom: 6 }}>Date Hired: 2023-11-12</div>
      ...
      {showLogout && (
        <LogOutModal onClose={() => setShowLogout(false)} onConfirm={handleConfirmLogout} />
      )}
